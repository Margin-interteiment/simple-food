$(function () {
  $(".discount-inner__list--active").slick({
    dots: true,
    arrows: false,
  });

  $(".header__menu-button").on("click", function () {
    $(".header__list").toggleClass("menu__list--active");
    $(".header__menu-button").toggleClass(".header__menu-button--active");
    $("body").toggleClass("lock");
  });

  $(".header__menu-button--active").on("click", function () {
    $(".header__list").removeClass("menu__list--active");
  });
